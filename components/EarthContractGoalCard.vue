...
const cartTypeMap = ref([
  ...
  {type: 'RoverTech', title: 'Oxygen condenser', image: 'RoverTech.png', bottomColor: '#060438FF', topColor: '#49615c'},
  {type: 'ShipTech', title: 'Rover', image: 'ShipTech.png', bottomColor: '#060438FF', topColor: '#49615c'},
  {type: 'UpgradeTech', title: 'Ship', image: 'UpgradeTech.png', bottomColor: '#060438FF', topColor: '#49615c'},
])
